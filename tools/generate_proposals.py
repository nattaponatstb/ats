...
def build_ca002_proposal(out_path):
    ...
    add_para(doc, "   3.2 เป้าหมายเชิงคุณภาพ: ความถูกต้องของข้อมูลชั่วโมงเรียนสะสมและระบบตารางสอนปราศจากข้อมูลชนกันอยู่ในระดับร้อยละ 100 และความพึงพอใจของกำลังพลผู้ใช้ระบบเฉลี่ยอยู่ในเกณฑ์ดีมาก (ร้อยละ 80 - 89) ตามเกณฑ์ประเมินกำลังพลกองทัพบก พ.ศ. 2562", size=15)
    ...
    add_para(doc, "   8.1 การวัดผลเชิงระบบ: ทำการทดสอบเจาะระบบและตรวจแฮชรหัสผ่านผู้ดูแลระบบ 100% พร้อมทดลองสลับปิดเน็ตตรวจความคงทนของระบบออฟไลน์\n"
                  "   8.2 การวัดความพึงพอใจ: ทำการประเมินความพึงพอใจการใช้ระบบตารางสอนดิจิทัลจากแอดมินและครูผู้สอนจำนวน 50 นาย โดยใช้เครื่องมือแบบมาตราส่วนประมาณค่า 5 ระดับ (Likert Scale) แล้วคำนวณผลคะแนนเฉลี่ยเป็นร้อยละเทียบกับเกณฑ์มาตรฐานตามระเบียบกองทัพบก ว่าด้วยการประเมินค่าการปฏิบัติงานกำลังพลของกองทัพบก พ.ศ. 2562 โดยเกณฑ์เฉลี่ยผลความพึงพอใจต้องอยู่ในระดับดีมาก (ร้อยละ 80 - 89)", size=15)
